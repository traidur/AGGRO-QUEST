...
LEVEL2_MANDATORY = {
    ...
    "paladin": (P, "Invocation of Sanctuary", "Invoking Aura of Sanctuary",
                dict(dmg=3, heal=0, block=0, strike=False, invocation="sanctuary", aggro=3,
    ...
    "wizard": (Z, "Fire Blast", "Fire Spear",
    ...
    "necromancer": (Nc, "Boneguard's Offering", "Boneguard's Bargain",
                    dict(combat_type="melee", dmg=1, heal=0, block=2, grants_range=True, dot=False,
                         ...
                         boosted_dmg=4, boosted_heal=-3, boosted_block=2, aggro=3, version=2)),
    "druid": (D, "Nature's Wildguard", "Nature's Rampart",
              dict(combat_type="melee", dmg=0, heal=2, block=3, tag="eclipse", aggro=2,
...
LEVEL2_PURCHASED_ORDER = {
    ...
    "cleric": [
        ...
        ("Void Mark", "Void Death Mark", dict(dmg=4, heal=0, block=0, sacred_balance=False,
         max_hp_buff=0, echo_dmg=1, aggro=1)),
    ],
    "paladin": [
        ("Might of the Aegis", "Wrath of the Aegis", dict(dmg=4, heal=0, block=2, strike=True,
         invocation=None, aggro=4, grants_aura_block=False)),
        ("Invocation of Grace", "Greater Invocation of Grace", dict(dmg=5, heal=0, block=0, strike=False,
         invocation="grace", aggro=3, grants_aura_block=False)),
        ("Holy Fortress", "Divine Fortress", dict(dmg=4, heal=0, block=4, strike=False,
         invocation=None, aggro=4, grants_aura_block=False)),
    ],
    "rogue": [
        ...
        ("Backstab and Dodge", "Piercing Backstab", dict(kind="plain", dmg=4, block=2,
    ...
    "ranger": [
        ...
        ("Crippling Shot", "Debilitating Shot", dict(dmg=2, block=2, grants_range=True,
    ...
    "runecaster": [
        ...
        ("Windstrike", "Hurricane Strike", dict(dmg=6, heal=0, block=0, grants_range=False,
         chain_bonus_if_prev=None, chain_bonus_dmg=0, echo_dmg=0, echo_heal=0, aggro=3)),
        ("Chain Lightning", "Chain Lightning [Lv 2]", dict(dmg=5, heal=0, block=0, grants_range=False,
         chain_bonus_if_prev=None, chain_bonus_dmg=0, echo_dmg=0, echo_heal=0, aggro=3)),
    ],
    "necromancer": [
        ("Soul Harvest", "Soul Feast", dict(combat_type="ranged", dmg=4, heal=2, block=0, grants_range=False,
         killing_blow=False, dot=False, dot_payoff=False, echo_dmg=0, aggro=2, version=2)),
        ("Sowing Dread", "Sowing Greater Dread", dict(combat_type="ranged", dmg=3, heal=0, block=0, grants_range=True,
         killing_blow=False, dot=True, dot_payoff=False, echo_dmg=0, aggro=2, version=2)),
        ("Reap", "Grim Reap", dict(combat_type="ranged", dmg=4, heal=0, block=0, grants_range=False,
         killing_blow=False, dot=False, dot_payoff=True, dot_multiplier=2, echo_dmg=0, aggro=3, version=3)),
    ],
    "druid": [
        ("Solar Flare", "Greater Solar Flare", dict(combat_type="ranged", dmg=6, heal=0, block=0,
         tag="eclipse", aggro=2)),
        ("Swipe", "Savage Swipe", dict(combat_type="melee", dmg=4, heal=0, block=0,
         tag="shapeshift", aggro=3)),
        ("Moonbeam", "Greater Moonbeam", dict(combat_type="ranged", dmg=6, heal=1, block=0,
         tag="eclipse", aggro=2)),
    ],
}
