...
ARCHETYPES = {
    'Martial': ['Warrior', 'Paladin'],
    'Magic': ['Wizard', 'Cleric', 'Runecaster', 'Necromancer'],
    'Agility': ['Rogue', 'Ranger', 'Druid']
}

print("--- AVERAGE NET DAMAGE (EV) BETWEEN ARCHETYPES ---")
for arch_A, classes_A in ARCHETYPES.items():
    for arch_B, classes_B in ARCHETYPES.items():
